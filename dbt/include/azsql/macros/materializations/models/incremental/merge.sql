...
{% macro azsql__get_merge_sql(target, source, unique_key, dest_columns, predicates) %}
  {{ default__get_merge_sql(target, source, unique_key, dest_columns, predicates) }};
{% endmacro %}

{% macro azsql__get_delete_insert_merge_sql(target, source, unique_key, dest_columns) %}
...
{% macro azsql__get_insert_overwrite_merge_sql(target, source, dest_columns, predicates, include_sql_header) %}

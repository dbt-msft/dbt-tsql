...
{% macro azsql__get_catalog(information_schemas, schemas) -%}
...
{% macro azsql__information_schema_name(database) -%}
  information_schema
{%- endmacro %}

{% macro azsql__list_schemas(database) %}
...
{% macro azsql__check_schema_exists(information_schema, schema) -%}
...
{% macro azsql__list_relations_without_caching(schema_relation) %}

...
from dbt.adapters.azsql import __version__
...
AZURE_AUTH_FUNCTION_TYPE = Callable[[AzureSQLCredentials], AccessToken]

logger = AdapterLogger("AzureSQL")
...
def get_cli_access_token(credentials: AzureSQLCredentials) -> AccessToken:
    """
    ...
    Parameters
    ----------
    credentials: AzureSQLConnectionManager
        The credentials.
...
def get_msi_access_token(credentials: AzureSQLCredentials) -> AccessToken:
    """
...
def get_auto_access_token(credentials: AzureSQLCredentials) -> AccessToken:
    """
...
def get_environment_access_token(credentials: AzureSQLCredentials) -> AccessToken:
    """
...
def get_sp_access_token(credentials: AzureSQLCredentials) -> AccessToken:
    """
...
def get_pyodbc_attrs_before(credentials: AzureSQLCredentials) -> Dict:
    """
...
class AzureSQLConnectionManager(SQLConnectionManager):
    TYPE = "azsql"
    ...
    @classmethod
    def get_credentials(cls, credentials: AzureSQLCredentials) -> AzureSQLCredentials:
        return credentials
